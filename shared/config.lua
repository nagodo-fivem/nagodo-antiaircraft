Config = { 
    ...
    Framework = "qb-core", -- Name of the framework you are using (qb-core, esx, standalone). If you are using standalone, you can only use vehicleModels
    ...
    Zones = {
        {
            ...
            needOneOfBoth = true, -- If true, player needs to has one of the jobs in the table below and should be in one of the vehicles in the table below
